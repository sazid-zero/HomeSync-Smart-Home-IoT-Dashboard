...
export const BentoFeatures: React.FC = () => {
    return (
        <section id="features" className="py-24 theme-bg-secondary overflow-hidden">
            <div className="max-w-[1280px] mx-auto px-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 grid-rows-2 gap-4 h-[800px] md:h-[600px]">
                    ...
                    <motion.div 
                        ...
                        className="md:col-span-2 md:row-span-2 relative group overflow-hidden rounded-[2.5rem] theme-bg-tertiary border theme-border"
                    >
                    ...
                    <motion.div 
                        ...
                        className="md:col-span-1 md:row-span-1 theme-card-bg border theme-border rounded-[2.5rem] p-8 flex flex-col justify-between group hover:border-cyan-500/50 transition-all duration-300 relative overflow-hidden"
                    >
                    ...
                    <motion.div 
                        ...
                        className="md:col-span-1 md:row-span-1 border theme-border rounded-[2.5rem] p-8 flex flex-col justify-between group hover:border-purple-500/50 transition-all duration-300 relative overflow-hidden bg-gradient-to-br from-purple-500/[0.03] to-transparent dark:from-purple-500/[0.08]"
                    >
                    ...
                    <motion.div 
                        ...
                        className="md:col-span-2 md:row-span-1 border theme-border rounded-[2.5rem] p-8 flex items-center space-x-8 group hover:border-blue-500/50 transition-all duration-300 relative overflow-hidden bg-gradient-to-r from-blue-500/[0.03] via-transparent to-transparent dark:from-blue-500/[0.08]"
                    >
