...
const DEFAULT_DEVICES = [
  ...
  { room: 'bedroom', name: 'Smart Humidifier', type: 'humidifier', control_type: 'slider', value: 45, is_on: true, icon_name: 'droplet' },
  ...
  try {
    ...
    for (const r of DEFAULT_ROOMS) {
      const res = await query(
        'INSERT INTO rooms (user_id, name, icon) VALUES ($1, $2, $3) RETURNING id',
        [userId, r.name, r.icon]
      );
    ...
    for (const d of DEFAULT_DEVICES) {
      await query(
        `INSERT INTO devices (room_id, user_id, name, type, control_type, is_on, value, power_consumption, icon_name)
         VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9)`,
        [roomIds[d.room], userId, d.name, d.type, d.control_type, d.is_on, d.value || 0, Math.random() * 5, d.icon_name]
      );
    }
